...
public final class ClientDaylightState {
    ...
    public static void initialize() {
        ClientPlayNetworking.registerGlobalReceiver(VariableLightNetworking.SNAPSHOT,
                (client, handler, buf, response) -> MAILBOX.offer(VariableLightNetworking.read(buf)));
