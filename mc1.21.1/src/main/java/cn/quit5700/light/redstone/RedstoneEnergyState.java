...
public final class RedstoneEnergyState extends SavedData {
    ...
    private static final SavedData.Factory<RedstoneEnergyState> TYPE = new SavedData.Factory<>(
            RedstoneEnergyState::new,
            (tag, registries) -> CODEC.parse(NbtOps.INSTANCE, tag).result().orElseGet(RedstoneEnergyState::new),
