...
public final class ModBlocks {
    public static final Identifier WAND_SETTINGS_STATION_ID = BuildingWandMod.id("wand_settings_station");
    public static final Block WAND_SETTINGS_STATION = Registry.register(
            ...
            new WandSettingsStationBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CRAFTING_TABLE)
                    .setId(ResourceKey.create(Registries.BLOCK, WAND_SETTINGS_STATION_ID)))
    );
